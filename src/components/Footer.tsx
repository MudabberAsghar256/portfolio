'use client';
import { ArrowUp, Github, Instagram, Linkedin, Mail, MapPin, Twitter } from "lucide-react";
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-4 group">
                <div className="w-10 h-10 glass rounded-xl flex items-center justify-center text-brand-primary shrink-0 group-hover:bg-brand-primary group-hover:text-blue-400 transition-all shadow-sm">
                  <Mail size={18} />
                </div>
                <a href="mailto:MudabberKhan@gmail.com">
                  <div>
                    <span className="block text-[10px] uppercase tracking-widest text-slate-400  font-mono">Email</span>
                    <span className="text-slate-600 group-hover:text-blue-400 transition-colors text-sm">hello@mudabber.dev</span>
                  </div>
                </a>
              </div>
              <div className="flex items-start gap-4 group">
                <div className="w-10 h-10 glass rounded-xl flex items-center justify-center text-brand-secondary shrink-0 group-hover:bg-brand-secondary group-hover:text-blue-400 transition-all shadow-sm">
                  <MapPin size={18} />
                </div>
                <div>
                  ...
                  <a
                    href="https://maps.google.com/?q=Elktech,office"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-slate-600 text-sm group-hover:text-blue-400 transition-colors"
                  >
                    Elktech Office
                  </a>
                </div>
